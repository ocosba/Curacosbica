...
ARQUETIPO_PRATICA = {
    1: 'Onde você chega, as pessoas relaxam. Não é algo que você faça de propósito: elas simplesmente se sentem seguras o bastante para começar de novo — num projeto, numa fase, numa versão nova delas mesmas.',
    2: 'Você diz em voz alta o que o grupo não estava conseguindo formular. Por isso a sua palavra pesa mais do que você imagina — e por isso o seu silêncio também pesa.',
    3: 'Você enxerga a possibilidade enquanto ela ainda é invisível para os outros. Não é intuição vaga: é ver antes, e depois esperar o mundo alcançar.',
    4: 'Ver a árvore dentro da semente é o que você faz sem esforço — em pessoas, em ideias, em projetos que ninguém mais aposta. O difícil é a paciência de esperar germinar.',
    5: 'O seu corpo sabe antes da sua cabeça, e quase nunca erra. Perto de você as pessoas lembram que existe uma inteligência abaixo do pensamento.',
    6: 'Você transita entre ambientes completamente distintos sem perder a essência. Aproxima quem estava longe e desarma conflito, porque enxerga que na alma todo mundo é igual.',
    7: 'Filosofar não te basta. Você pega os recursos do mundo, conserta o que está falho e transforma em coisa concreta o que era só visão.',
    8: 'A forma importa, e você é quem lembra disso. O modo como algo é feito e apresentado faz parte da verdade daquilo — quando o acabamento é torto, o conteúdo mente um pouco.',
    9: 'As emoções travadas de um sistema — família, equipe, relação — encontram vazão perto de você. É um trabalho invisível e cansativo, e quase ninguém agradece.',
    10: 'Existe vínculo que não se compra e não se negocia, e você é prova viva disso. É a sua maior força, e também onde você mais se machuca.',
    11: 'Você desmonta a solenidade pelo riso, nunca pelo sermão. Boa parte do que as pessoas levam a sério é convenção, e você percebe isso antes de todo mundo.',
    12: 'Escolher é o seu verbo. Onde parecia haver só destino, você mostra que havia decisão — e cobra isso dos outros também.',
    13: 'Você vai onde os outros não vão e volta com notícia do que existe do outro lado. Fronteira, pra você, é convite.',
    14: 'Você é o ponto de calma num sistema acelerado. Não faz esforço nenhum e mesmo assim reorganiza o ambiente — é impressionante o quanto o tempo desacelera perto de você.',
    15: 'Enquanto os outros ainda estão dentro do problema, você já viu o padrão inteiro de cima. Altitude é o seu recurso; descer dela é o seu treino.',
    16: 'Você é a pergunta viva num ambiente que se acomodou. Incomoda antes de libertar, e quase sempre nessa ordem.',
    17: 'Você lê os sinais e mostra que existe uma ordem operando, mesmo quando parece caos. O seu relógio é o tempo natural, não o calendário.',
    18: 'Perto de você as pessoas se veem de verdade — e nem sempre agradecem na hora. Refletir sem distorcer é uma gentileza que costuma parecer dureza.',
    19: 'Mudança necessária passa por você, inclusive quando chega em forma de colapso. Você não provoca a tempestade: você é por onde ela entra.',
    20: 'Dá pra ser maduro, generoso e verdadeiro ao mesmo tempo, e você é a prova. Ilumina sem precisar apontar para si mesmo.',
    21: 'Todo movimento parte de você. É o centro — e o centro não se move.',
}
